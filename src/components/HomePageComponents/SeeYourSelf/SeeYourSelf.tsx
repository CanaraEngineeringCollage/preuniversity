...
//             Canara Pre-University College, established in 1972, offers two-year
//             Pre-University education in Commerce (BSBA, BEBA, CSBA, CEBA, SEBA &
//             HEBA) & Science (PCMB, PCMC, PCME, PCMS) streams. With a focus on
//             academic excellence, character building & overall personality
//             development, the college nurtures students in a supportive,
//             inclusive environment.
//           </p>

//           <p className="text-[#2A2A2A] lg2:text-xl text-justify pt-4 lg2:pt-8">
//             Located in the heart of the city, the campus features well-equipped
//             labs, a modern library, reading room & canteen. Students are
//             encouraged to take part in co-curricular activities, with achievers
        ...
        <div className="flex flex-col lg:col-span-7">
          ...
          <div className="flex pt-5 pb-1 lg:hidden items-center justify-center  lg2:p-16 ">
            ...
            <Image
              ...
              src="/images/homePageImages/image11.png"
