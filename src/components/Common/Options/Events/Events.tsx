...
export default function Events() {
  ...
  return (
    <Menu open={isMenuOpen} handler={setIsMenuOpen} offset={{ mainAxis: 20 }} placement="bottom" allowHover={true}>
      ...
      <MenuList className="w-full bg-transparent !top-[210px] text-[#1D1D1F]  p-0  z-100 border-none !border-0 shadow-none flex justify-center pb-4 outline-none focus:ring-0">
