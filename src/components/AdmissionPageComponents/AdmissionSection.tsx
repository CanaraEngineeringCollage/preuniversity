      ...
      <div className="">
        ...
        <div className="grid grid-cols-1  md:grid-cols-12 mt-10">
          ...
          <div className="col-span-7 mt-7 md:mt-0">
            {AdmissionData[selectedIndex]?.subTitle && <p className="text-lg mb-3 text-[#2A2A2A]  cursor-pointer">{AdmissionData[selectedIndex].subTitle}</p>}
        ...
        <div className="mt-10  space-y-2">
          ...
          <p className="text-[#2A2A2A] text-lg">
            ...
            <span className="lg:ml-20">
              <span className="font-bold"><br />Email:</span> canarapu@gmail.com
            </span>
          </p>
        </div>
      </div>
