    ...
    <>
          ...
          <div className="fixed inset-0 flex justify-center   z-50 overflow-auto">
            ...
            >
              <motion.button
                ...
                onClick={handleClose}
              >
                <IoClose className="h-6 w-6  text-neutral-100 dark:text-neutral-900" />
              </motion.button>
      ...
      >
        ...
        <motion.div className="absolute  bottom-4 z-100 text-center w-full">
          <motion.button className="text-white border rounded-4xl text-base md:text-base py-2 font-bold px-6 mt-2">{title}</motion.button>
        </motion.div>
        <BlurImage
          src={imageSrc}
      ...
      <motion.button
  onClick={handleOpen}
  className="rounded-xl dark:bg-neutral-900 h-full w-full overflow-hidden bg-gradient-to-t from-black/100 flex flex-col items-start justify-start relative z-10"
>
  <motion.div
    className="absolute top-[70%] h-[30%] inset-x-0 z-[100] pointer-events-none"
    style={{
